...
const PXL_Gradient PXL_GRADIENT_WHITE_BLACK			= PXL_Gradient(0xffffff00, 0x000000ff);		/**> Pre-defined white to black gradient colour **/
const PXL_Gradient PXL_GRADIENT_RED_BLACK			= PXL_Gradient(0xff0000ff, 0x000000ff);		/**> Pre-defined red to black gradient colour **/
